...
layer.config({
	...
	if ($("#fixednavbar").click(function() {
		...
		return $("body").removeClass("skin-1"), $("body").removeClass("skin-2"), $("body").removeClass("skin-3"),$(".sidebar-collapse").css('background','#ccc'), !1
	}), $(".s-skin-1").click(function() {
		return $("body").removeClass("skin-2"), $("body").removeClass("skin-3"), $("body").addClass("skin-1"),$(".sidebar-collapse").css('background','#d3e1f1'), !1
	}), $(".s-skin-3").click(function() {
		return $("body").removeClass("skin-1"), $("body").removeClass("skin-2"), $("body").addClass("skin-3"),$(".sidebar-collapse").css('background','#f3d0d0'), !1
	}), localStorageSupport) {
